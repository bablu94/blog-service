...
type BlogServiceClient interface {
	...
	ReadPost(ctx context.Context, in *PostIdRequest, opts ...grpc.CallOption) (*PostResponse, error)
...
func (c *blogServiceClient) CreatePost(ctx context.Context, in *PostRequest, opts ...grpc.CallOption) (*PostResponse, error) {
...
func (c *blogServiceClient) ReadPost(ctx context.Context, in *PostIdRequest, opts ...grpc.CallOption) (*PostResponse, error) {
	out := new(PostResponse)
...
type BlogServiceServer interface {
	...
	ReadPost(context.Context, *PostIdRequest) (*PostResponse, error)
...
func (UnimplementedBlogServiceServer) CreatePost(context.Context, *PostRequest) (*PostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatePost not implemented")
}
func (UnimplementedBlogServiceServer) ReadPost(context.Context, *PostIdRequest) (*PostResponse, error) {
...
func _BlogService_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).CreatePost(ctx, req.(*PostRequest))
	}
